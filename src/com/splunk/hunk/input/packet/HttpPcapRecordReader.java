...
public class HttpPcapRecordReader extends BaseSplunkRecordReader {

	private static final Logger gLogger = Logger.getLogger(HttpPcapRecordReader.class);

	private String packet_type_class = "net.ripe.hadoop.pcap.HttpPcapReader";
	...
	// for pcap
	private HttpPacketEventProcessor objectPreProcessor;
...
*/		
	private Map<String, Object> createEventFromPacket(Packet packet) {
		...
		Map<String, Object> oData = objectPreProcessor.createEventFromPacket((HttpPacket)packet);
		return oData;
	}
